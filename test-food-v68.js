/* =============================================================================
   BỘ TEST NHẬN DIỆN & TÍNH CALO — V68
   Chạy:  node test-food-v68.js        (cần: npm i jsdom)
...
/* Calo và macro phải là cùng một phép nhân: chênh lệch 4-4-9 phải nhỏ.
   Trừ đồ uống có cồn — năng lượng ở đó đến từ cồn, không phải macro. */
const ALL = [...RECOGNITION.map((x) => x[0]), ...AMOUNT.map((x) => x[0])];
let drift = 0;
